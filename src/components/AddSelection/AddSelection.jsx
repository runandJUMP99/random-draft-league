...
const AddSelection = ({ submittedSelection, setShowModal }) => {
  ...
  const selection = useSelector(
    state =>
      selectionId && state.selections.selections.find(s => s.id === selectionId)
  );
  ...
  useEffect(() => {
    if (selection) {
      ...
      setSelectionData({
        ...
        description: "",
        img: "",
        netLikes: submittedSelection.netLikes,
        thumbsDownVoters: submittedSelection.thumbsDownVoters,
        thumbsUpVoters: submittedSelection.thumbsUpVoters,
    ...
    <Paper className={classes.Paper}>
      ...
      >
        ...
        <TextField
          ...
          name="name"
          onChange={event =>
            setSelectionData({ ...selectionData, name: event.target.value })
          }
          required
        ...
        <div className={classes.FileInput}>
          <FileBase
            multiple={false}
            onDone={({ base64 }) =>
              setSelectionData({ ...selectionData, img: base64 })
            }
            type="file"
          />
        </div>
        ...
        <Button
          ...
          variant="contained"
          style={{
            display: !submittedSelection && "none",
